...
--
This document describes the fields that are exported by Alphasocbeat. They are
grouped in the following categories:

* <<exported-fields-alphasocbeat>>
...
*`alphasoc.event.qtype`*::
+
--
type: alias

alias to: dns.question.type

--

*`alphasoc.event.method`*::
+
--
type: keyword
...
*`alphasoc.wisdom.domain`*::
+
--
type: alias

alias to: destination.domain

--

*`alphasoc.wisdom.flags`*::
+
--
type: keyword
