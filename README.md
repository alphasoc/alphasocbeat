...
`${GOPATH}/src/github.com/alphasoc/alphasocbeat`
...
```
git remote set-url origin https://github.com/alphasoc/alphasocbeat
...
in the same directory with the name alphasocbeat.
...
```
./alphasocbeat -c alphasocbeat.yml -e -d "*"
```
...
```
mkdir -p ${GOPATH}/src/github.com/alphasoc/alphasocbeat
git clone https://github.com/alphasoc/alphasocbeat ${GOPATH}/src/github.com/alphasoc/alphasocbeat
```
